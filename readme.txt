...
prediction_script.py - Build the prediction model and calculate accuracy.
views.py - Functions to indicate the web pages.
models.py - Models of the database.
forms.py - To generate the form in the Django Template.
urls.py - For managing the urls.
templates/index.html, static/style.css - The django template for the web page.
...
Ruzan Sasuri(rps7183)
_____________________________________

Clean up of data
Scripting for prediction
Integration testing
Report Writing
